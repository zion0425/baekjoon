...
public class Solution {
    ...
    private static ArrayList<Core> coreList;
    ...
    private static boolean[][] clone(boolean[][] v) {
    ...
    public static void dfs(int depth, boolean[][] visit, int sum, int cnt) {
    ...
    public static int moveDirect(Core core, int deltaNo, boolean[][] cVisit) {
        int dy = core.y;
        int dx = core.x;
        int cnt = 0;
        while (true) {
